...
int Pwm::pwm_enable() {
    ...
    sprintf(setpin_,"/sys/class/pwm/pwmchip0/pwm%d/enable", pwm_pin_);
...
int Pwm::pwm_polarity(bool value) {
    ...
    sprintf(setpin_,"/sys/class/pwm/pwmchip0/pwm%d/polarity", pwm_pin_);
...
int Pwm::pwm_period(int value) {
    ...
    sprintf(setpin_,"/sys/class/pwm/pwmchip0/pwm%d/period", pwm_pin_);
...
int Pwm::pwm_duty_cycle(int value) {
    ...
    sprintf(setpin_,"/sys/class/pwm/pwmchip0/pwm%d/duty_cycle", pwm_pin_);
