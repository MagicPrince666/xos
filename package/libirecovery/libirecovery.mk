...
HOST_LIBIRECOVERY_SUBDIR = .

LIBIRECOVERY_INSTALL_STAGING = YES

LIBIRECOVERY_CONF_OPTS = 

LIBIRECOVERY_DEPENDENCIES =
HOST_LIBIRECOVERY_DEPENDENCIES =

LIBIRECOVERY_LICENSE = LGPL-2.1+
LIBIRECOVERY_LICENSE_FILES = $(LIBIRECOVERY_SUBDIR)/COPYING.LIB
HOST_LIBIRECOVERY_LICENSE = GPL-2.0+ (libirecovery)
HOST_LIBIRECOVERY_LICENSE_FILES = COPYING $(LIBIRECOVERY_SUBDIR)/COPYING.LIB

HOST_LIBIRECOVERY_CONF_ENV = MAKEINFO=true
HOST_LIBIRECOVERY_LIBIRECOVERY_PATCH = NO
...
HOST_LIBIRECOVERY_PRE_CONFIGURE_HOOKS += LIBIRECOVERY_AVOID_AUTORECONF_HOOK
