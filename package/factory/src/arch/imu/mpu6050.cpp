...
static uint8_t i2c_write(int fd, uint8_t reg, uint8_t val);
static uint8_t i2c_read(int fd, uint8_t reg, uint8_t *val);
static uint8_t printarray(uint8_t Array[], uint8_t Num);
